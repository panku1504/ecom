      ...
      <div className="container-fluid my-2">
        <div className="row">
          ...
          <div className="col-md-9">
            <h4 className='bg-dark text-center text-light p-2 '>Brand
              <Link to="/admin/brand/create"><i className='bi bi-plus text-light float-end fs-3'></i></Link>
            </h4>
                ...
                <tbody>
                  {data.map(item => {
                    return <tr key={item.id}>
                      ...
                      <td><Link to={`/admin/brand/update/${item.id}`} className='btn btn-dark'><i className='bi bi-pencil-square'></i></Link></td>
