      ...
      <div className="container-fluid my-2">
        <div className="row">
          ...
          <div className="col-md-9">
            <h4 className='bg-dark text-center text-light p-2 '>Maincategory
                ...
                <tbody>
                  {data.map(item => {
                    return <tr key={item.id}>
                      ...
                      <td><Link to={`/admin/maincategory/update/${item.id}`} className='btn btn-dark'><i className='bi bi-pencil-square'></i></Link></td>
